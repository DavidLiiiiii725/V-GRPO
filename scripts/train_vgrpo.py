#!/usr/bin/env python
"""Entry point for V-GRPO training."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--run_name", default="vgrpo")
...
def main() -> None:
    args = parse_args()
    cfg = TrainConfig(use_vgrpo=True, run_name=args.run_name, total_steps=args.total_steps)
